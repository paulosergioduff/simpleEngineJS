...
function desenhaNaTela()
			  	{
			  		...
			  		//desenhaCenario()
			  		window.document.getElementById('caixa').innerHTML = '<canvas style="background-color: blue; width: 150px; height: 150px; transform: perspective( '+perspective+'px ) rotateY( '+rotateY+'deg ) rotateX( '+rotateX+'deg ); background-size:100% 100%" class="poster">x</canvas>';
			  		}
